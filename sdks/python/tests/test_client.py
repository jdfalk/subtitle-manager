...
class TestSubtitleManagerClient:
    ...
    def setup_method(self):
        ...
        self.client = SubtitleManagerClient(
            base_url="http://test.example.com", api_key="test-api-key"
        )
    ...
    def test_get_logs(self):
        ...
        responses.add(
            responses.GET, "http://test.example.com/api/logs", json=log_data, status=200
        )
    ...
    def test_get_history(self):
        ...
        result = self.client.get_history(
            page=1, limit=20, operation_type=OperationType.DOWNLOAD
        )
    ...
    def test_repr(self):
        ...
        assert (
            repr(client) == "SubtitleManagerClient(base_url='http://test.example.com')"
        )
